                ...
                <div class="md:p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        ...
                        <div class="flex justify-end mb-4">
                            <button onclick="location.href='{{ route('admin.owners.create') }}'"class="  bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">新規登録する</button>
                        </div>
                              ...
                              <tbody>
                                ...
                                <tr>                        
                                  ...
                                  <td class="md:px-4 py-3 ">
                                    <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="  bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-400">編集</button>
                                  </td>
                                  <form id="delete_{{ $owner->id }}" method="post" action="{{ route('admin.owners.destroy', ['owner' => $owner->id]) }}">
                                    @csrf
                                    @method('delete')
                                    <td class="md:px-4 py-3 ">
                                        <a href='#' data-id="{{ $owner->id }}" onclick="deletePost(this)" class="  bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-400">削除</a>
                                    </td>
                                  </form>
                                </tr>
                                @endforeach
